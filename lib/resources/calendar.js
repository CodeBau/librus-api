...
module.exports = class Calendar extends Resource {
   ...
   */
  static get API_REVISION() { return "2026.06.14.calendar_post_fix"; }
  ...
  getCalendar(month, year) {
    ...
    // Jeśli podano parametry, używamy POST, aby uniknąć 404 na niektórych wersjach Synergii
    if (month && year) {
      let formData = new FormData();
      formData.append("miesiac", targetMonth);
      formData.append("rok", targetYear);
    ...
    // Domyślny widok (bieżący miesiąc) pobieramy prostym GETem
    return this.api._mapper("terminarz", "table.kalendarz.decorated.center tbody td .kalendarz-dzien", parser);
  }
